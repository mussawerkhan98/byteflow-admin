  ...
  sections: {
    ...
    fields: [
      { name: "page_id", label: "Page ID", type: "number", required: true },
      {
        ...
        label: "Section type",
        type: "select",
        options: ["hero", "founder"],
        required: true,
        help: "Services, FAQs, Reviews, Calls to action, and Team each have their own dedicated page in the sidebar — use those instead, they're what the website actually reads.",
      },
