...
export const resources = {
  ...
  sections: {
    ...
    fields: [
      { name: "page_id", label: "Page", type: "number", required: true },
      {
        name: "section_type",
        label: "Section type",
        type: "select",
        options: ["custom", "hero", "founder"],
        required: true,
        help: "“custom” is a content block that appears near the bottom of the page you choose. “hero” and “founder” feed the top banner and the About Us founder block. Services, FAQs, Reviews, Calls to action and Team each have their own screen in the sidebar.",
      },
      {
        name: "name",
        label: "Section name",
        type: "text",
        required: true,
        help: "Only used to identify this block in the list below — visitors never see it.",
      },
      {
        name: "content",
